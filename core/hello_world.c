...
static char __pyx_k_Created_on_Sat_Feb_20_13_13_43[] = "\nCreated on Sat Feb 20 13:13:43 2016\n\n@author: Brian\n";
...
static struct PyModuleDef __pyx_moduledef = {
  ...
  #endif
    "hello_world",
    __pyx_k_Created_on_Sat_Feb_20_13_13_43, /* m_doc */
    -1, /* m_size */
...
#endif
{
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("hello_world", __pyx_methods, __pyx_k_Created_on_Sat_Feb_20_13_13_43, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "hello_world")) {
      if (unlikely(PyDict_SetItemString(modules, "hello_world", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 * print "Hello world!"             # <<<<<<<<<<<<<<
 */
  if (__Pyx_PrintOne(0, __pyx_kp_s_Hello_world) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 8; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
