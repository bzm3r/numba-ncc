...
# -----------------------------------------------------------------
    def pack_rhs_arguments(self, t, this_cell_index, all_cells_node_coords, intercellular_squared_dist_array, are_nodes_inside_other_cells, close_point_on_other_cells_to_each_node_exists, close_point_on_other_cells_to_each_node_dist, external_gradient_on_nodes):
        access_index = self.get_system_info_access_index(t)
...
# -----------------------------------------------------------------
    def execute_step(self, this_cell_index, num_nodes, all_cells_node_coords, intercellular_squared_dist_array, line_segment_intersection_matrix, external_gradient_fn, be_talkative=False):
        ...
        if self.skip_dynamics == False:            
            ...
            rhs_args = self.pack_rhs_arguments(self.curr_tpoint, this_cell_index, all_cells_node_coords, intercellular_squared_dist_array, are_nodes_inside_other_cells, close_point_on_other_cells_to_each_node_exists, close_point_on_other_cells_to_each_node_dist, external_gradient_on_nodes)
