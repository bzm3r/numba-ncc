...
#    print "F_adhesion: ", F_adhesion
    ...
    kgtps_rac = chemistry.calculate_kgtp_rac(conc_rac_membrane_actives, exponent_rac_autoact, threshold_rac_autoact, kgtp_rac_baseline, kgtp_rac_autoact_baseline, transduced_coa_signals, chemoattractant_shielding_effect_factor_on_nodes, chemoattractant_mediated_coa_dampening, chemoattractant_signal_on_nodes, randomization_rac_kgtp_multipliers, intercellular_contact_factors, close_point_smoothness_factors)
