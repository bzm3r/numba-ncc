...
#    print "F_adhesion: ", F_adhesion
    ...
    kgtps_rac = chemistry.calculate_kgtp_rac(num_nodes, conc_rac_membrane_actives, migr_bdry_contact_factors, exponent_rac_autoact, threshold_rac_autoact, kgtp_rac_baseline, kgtp_rac_autoact_baseline, transduced_coa_signals, endocytosis_effect_factor_on_nodes, coa_dampening_factor, chemoattractant_signal_on_nodes, randomization_rac_kgtp_multipliers, intercellular_contact_factors, close_point_smoothness_factors)
