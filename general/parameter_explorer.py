...
#  ('randomization_magnitude', 2.0, 20.0, 1.0), ('stiffness_edge', 1000.0, 8000.0, 500.0), ('randomization_node_percentage', 0.25, 0.5, 0.05)]
    ...
    BEST_UPDATES = parameter_explorer_polarization_wanderer_no_randomization_variant(moddable_parameters, 0.8, num_new_dicts_to_generate=int(len(moddable_parameters)), num_experiment_repeats=5, num_processes=4, total_time_in_hours=2., seed=None, sequential=False, should_be_polarized_by_in_hours=1./6.)
