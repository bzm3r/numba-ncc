...
base_output_dir = "C:\\Users\\Brian Merchant\\numba-ncc\\output"

parameter_dict.update([('kgtp_rac_multiplier', 15.0),
  ('kgtp_rho_multiplier', 14.0),
  ('kdgtp_rac_multiplier', 4.0),
  ('kdgtp_rho_multiplier', 40.0),
  ('kgtp_rac_autoact_multiplier', 500.0),
  ('kgtp_rho_autoact_multiplier', 65.0),
  ...
  ('tension_mediated_rac_inhibition_magnitude', 77.0),
  ('max_force_rac', 3000.0),
  ('eta', 10000.0),
  ('stiffness_edge', 8000.0), ('randomization_time_mean', 40.0), ('randomization_time_variance_factor', 0.1), ('randomization_magnitude', 4.0), ('randomization_node_percentage', 0.25)])

sub_experiment_number = 0

ets.single_cell_polarization_test(date_str, experiment_number, sub_experiment_number, copy.deepcopy(parameter_dict), no_randomization=True, base_output_dir=base_output_dir, total_time_in_hours=2., timestep_length=2, verbose=True, integration_params={'rtol': 1e-2}, max_timepoints_on_ram=max_timepoints_on_ram, seed=2345, allowed_drift_before_geometry_recalc=allowed_drift_before_geometry_recalc, default_coa=0.0, default_cil=0.0, num_experiment_repeats=1, timesteps_between_generation_of_intermediate_visuals=None, produce_final_visuals=True, full_print=True, delete_and_rerun_experiments_without_stored_env=True, remake_visualizations=remake_visualizations)


parameter_dict.update([('kgtp_rac_multiplier', 10.0),
  ('kgtp_rho_multiplier', 14.0),
  ('kdgtp_rac_multiplier', 4.0),
  ('kdgtp_rho_multiplier', 40.0),
  ('kgtp_rac_autoact_multiplier', 500.0),
...
'''
Interestingly, experiments are quite insensitive to changes in kgtp_rac_multiplier, suggesting that kgtp_rac_autoact multiplier might be the culprit.
'''
...
parameter_dict.update([('kgtp_rac_multiplier', 10.0),
  ...
  ('kdgtp_rac_mediated_rho_inhib_multiplier', 200.0),
  ('kdgtp_rho_mediated_rac_inhib_multiplier', 2000.0), ('tension_mediated_rac_inhibition_half_strain', 0.1),
  ('tension_mediated_rac_inhibition_magnitude', 55.0),
  ('max_force_rac', 3000.0),
  ('eta', 10000.0),
  ('stiffness_edge', 8000.0), ('randomization_time_mean', 40.0), ('randomization_time_variance_factor', 0.1), ('randomization_magnitude', 4.0), ('randomization_node_percentage', 0.25)])
...
parameter_dict.update([('kgtp_rac_multiplier', 12.0),
  ...
  ('kdgtp_rac_mediated_rho_inhib_multiplier', 200.0),
  ('kdgtp_rho_mediated_rac_inhib_multiplier', 2000.0), ('tension_mediated_rac_inhibition_half_strain', 0.1),
  ('tension_mediated_rac_inhibition_magnitude', 75.0),
  ('max_force_rac', 3000.0),
  ('eta', 10000.0),
  ('stiffness_edge', 8000.0), ('randomization_time_mean', 40.0), ('randomization_time_variance_factor', 0.1), ('randomization_magnitude', 4.0), ('randomization_node_percentage', 0.25)])
...
parameter_dict.update([('kgtp_rac_multiplier', 12.0),
  ...
  ('max_force_rac', 3000.0),
  ('eta', 10000.0),
  ('stiffness_edge', 8000.0), ('randomization_time_mean', 40.0), ('randomization_time_variance_factor', 0.1), ('randomization_magnitude', 8.0), ('randomization_node_percentage', 0.25)])

sub_experiment_number = 9

ets.single_cell_polarization_test(date_str, experiment_number, sub_experiment_number, copy.deepcopy(parameter_dict), no_randomization=False, base_output_dir=base_output_dir, total_time_in_hours=4., timestep_length=2, verbose=True, integration_params={'rtol': 1e-2}, max_timepoints_on_ram=max_timepoints_on_ram, seed=2345, allowed_drift_before_geometry_recalc=allowed_drift_before_geometry_recalc, default_coa=0.0, default_cil=0.0, num_experiment_repeats=3, timesteps_between_generation_of_intermediate_visuals=None, produce_final_visuals=True, full_print=True, delete_and_rerun_experiments_without_stored_env=True, remake_visualizations=remake_visualizations)
