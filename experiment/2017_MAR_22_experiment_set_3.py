...
parameter_dict = dict(
    [
        ...
        ("interaction_factor_migr_bdry_contact", 10),
...
parameter_dict.update(
    [
        ...
        ("threshold_rac_activity_multiplier", 0.4),
        ("threshold_rho_activity_multiplier", 0.4),
        ("kgtp_rac_autoact_multiplier", 1.0),
        ("kgtp_rho_autoact_multiplier", 1.0),
        ("kdgtp_rac_mediated_rho_inhib_multiplier", 1.0),
        ("kdgtp_rho_mediated_rac_inhib_multiplier", 5.0),
    ]
)
...
parameter_dict.update(
    [
        ...
        ("kgtp_rac_autoact_multiplier", 1.0),
        ("kgtp_rho_autoact_multiplier", 1.0),
        ("kdgtp_rac_mediated_rho_inhib_multiplier", 5.0),
...
parameter_dict.update(
    [
        ("kgtp_rac_multiplier", 1.5460521835862795),
        ("kgtp_rho_multiplier", 1.0),
        ("kdgtp_rac_multiplier", 1.0),
...
parameter_dict.update(
    [
        ...
        ("kdgtp_rac_multiplier", 20 * (2 / 3.0)),
        ("kdgtp_rho_multiplier", 20 * (2 / 3.0)),
...
parameter_dict.update(
    [
        ("kgtp_rac_multiplier", 20.0),
        ("kgtp_rho_multiplier", 20.0),
        ("kdgtp_rac_multiplier", 15.0),
        ("kdgtp_rho_multiplier", 15.0),
        ("threshold_rac_activity_multiplier", 0.5),
        ("threshold_rho_activity_multiplier", 0.5),
