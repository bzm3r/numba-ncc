...
##
test_Trs = [5.0, 10.0, 15.0, 20.0, 25.0, 30.0, 35.0, 40.0, 45.0, 50.0, 55.0, 60.0]
ets.Tr_vs_Tp_test(
    date_str,
    experiment_number,
...
#  ('max_force_rac', 3000.0),
#  ('eta', 2.9*10000.0),
#  ('stiffness_edge', 8000.0), ('randomization_time_mean', 30.0), ('randomization_time_variance_factor', 0.1), ('randomization_magnitude', 12.0), ('randomization_node_percentage', 0.25)])
#
...
#  ('max_force_rac', 3000.0),
#  ('eta', 2.9*10000.0),
#  ('stiffness_edge', 8000.0), ('randomization_time_mean', 40.0), ('randomization_time_variance_factor', 0.1), ('randomization_magnitude', 12.0), ('randomization_node_percentage', 0.25)])
#
...
#  ('max_force_rac', 3000.0),
#  ('eta', 2.9*10000.0),
#  ('stiffness_edge', 8000.0), ('randomization_time_mean', 50.0), ('randomization_time_variance_factor', 0.1), ('randomization_magnitude', 12.0), ('randomization_node_percentage', 0.25)])
#
...
#  ('max_force_rac', 3000.0),
#  ('eta', 2.9*10000.0),
#  ('stiffness_edge', 8000.0), ('randomization_time_mean', 60.0), ('randomization_time_variance_factor', 0.1), ('randomization_magnitude', 12.0), ('randomization_node_percentage', 0.25)])
#
# sub_experiment_number = 60
#
# coa_dict = {49: 8.0, 36: 8.0, 25: 12.0, 16: 14.0, 9: 16.0, 4: 24.0, 2: 24.0, 1: 24.0}
#
# ets.single_cell_polarization_test(date_str, experiment_number, sub_experiment_number, copy.deepcopy(parameter_dict), no_randomization=False, base_output_dir=base_output_dir, total_time_in_hours=4., timestep_length=2, verbose=True, integration_params=integration_params, max_timepoints_on_ram=max_timepoints_on_ram, seed=None, allowed_drift_before_geometry_recalc=allowed_drift_before_geometry_recalc, default_coa=0.0, default_cil=0.0, num_experiment_repeats=50, timesteps_between_generation_of_intermediate_visuals=None, produce_final_visuals=True, full_print=True, delete_and_rerun_experiments_without_stored_env=True, remake_graphs=True, remake_animation=False, show_centroid_trail=True, show_randomized_nodes=False)
