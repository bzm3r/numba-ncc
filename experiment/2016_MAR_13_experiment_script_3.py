...
biased_rgtpase_distrib_defn_dicts += [[{'default': ['biased uniform', np.array([-np.pi/4, np.pi/4]) + np.pi/32 + np.pi, 0.4]}, {'default': ['unbiased random', np.array([-np.pi/4, np.pi/4]) + np.pi + np.pi/32, 0.1]}]]
