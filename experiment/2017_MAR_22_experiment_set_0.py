...
parameter_dict.update(
    [
        ...
        ("kgtp_rho_multiplier", 10),
        ("kdgtp_rac_multiplier", 1),
        ("kdgtp_rho_multiplier", 8),
        ("threshold_rac_activity_multiplier", 0.10000000000000001),
        ("threshold_rho_activity_multiplier", 0.8),
        ("kgtp_rac_autoact_multiplier", 675),
        ("kgtp_rho_autoact_multiplier", 600),
        ("kdgtp_rac_mediated_rho_inhib_multiplier", 350),
        ("kdgtp_rho_mediated_rac_inhib_multiplier", 225),
    ]
)
