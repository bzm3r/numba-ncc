...
parameter_dict.update([('kgtp_rac_multiplier', 2.0),
  ('kgtp_rho_multiplier', 8.0),
  ('kdgtp_rac_multiplier', 33.0),
  ('kdgtp_rho_multiplier', 36.0),
  ('threshold_rac_activity_multiplier', 0.20000000000000001),
  ('threshold_rho_activity_multiplier', 0.75),
  ('kgtp_rac_autoact_multiplier', 121.0),
  ('kgtp_rho_autoact_multiplier', 181.0),
  ('kdgtp_rac_mediated_rho_inhib_multiplier', 1900.0),
