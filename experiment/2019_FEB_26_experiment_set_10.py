...
if __name__ == "__main__":
    ...
    num_experiment_repeats = [50, 20, 20, 3, 3, 3, 3, 3][x:y]
    info_tag = ""
    coa_knockdown = 1.0
    cil_knockdown = 1.0
    ...
    ets.chemotaxis_no_corridor_tests(
        ...
        do_final_analysis=True,
        default_coas=[coa_knockdown*coa_dict[x] for x in test_cell_group_sizes],
        default_cil=cil_knockdown*default_cil,
