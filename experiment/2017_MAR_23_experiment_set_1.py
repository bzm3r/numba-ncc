...
parameter_dict.update([('kgtp_rac_multiplier', 17.0),
 ('kgtp_rho_multiplier', 5.0),
 ('kdgtp_rac_multiplier', 2.0),
 ('kdgtp_rho_multiplier', 5.0),
 ('threshold_rac_activity_multiplier', 0.8),
 ('threshold_rho_activity_multiplier', 0.5199999999999998),
 ('kgtp_rac_autoact_multiplier', 244.0),
 ('kgtp_rho_autoact_multiplier', 82.0),
 ('kdgtp_rac_mediated_rho_inhib_multiplier', 342.0),
 ('kdgtp_rho_mediated_rac_inhib_multiplier', 500.0),
 ('tension_mediated_rac_inhibition_half_strain', 0.050000000000000003)])
