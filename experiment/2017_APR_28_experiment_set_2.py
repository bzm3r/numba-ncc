...
parameter_dict.update([('kgtp_rac_multiplier', 1.75*10.0),
  ...
  ('tension_mediated_rac_inhibition_half_strain', 0.02), ('tension_mediated_rac_inhibition_magnitude', 4.75), ('max_force_rac', 0.1*10e3), ('eta', 0.1*1e5), ('randomization_time_mean', 40.0), ('randomization_time_variance_factor', 0.1), ('randomization_magnitude', 6.0), ('randomization_node_percentage', 0.5), ('stiffness_edge', 4500.)])
...
parameter_dict.update([('kgtp_rac_multiplier', 1.75*10.0),
  ...
  ('kdgtp_rac_mediated_rho_inhib_multiplier', 2000.0),
  ('kdgtp_rho_mediated_rac_inhib_multiplier', 2000.0),
  ('tension_mediated_rac_inhibition_half_strain', 0.02), ('tension_mediated_rac_inhibition_magnitude', 4.75), ('max_force_rac', 0.1*10e3), ('eta', 0.1*1e5), ('randomization_time_mean', 40.0), ('randomization_time_variance_factor', 0.1), ('randomization_magnitude', 6.0), ('randomization_node_percentage', 0.5), ('stiffness_edge', 4000.)])
...
parameter_dict.update([('kgtp_rac_multiplier', 1.75*10.0),
  ...
  ('kdgtp_rac_mediated_rho_inhib_multiplier', 2000.0),
  ('kdgtp_rho_mediated_rac_inhib_multiplier', 2000.0),
  ('tension_mediated_rac_inhibition_half_strain', 0.02), ('tension_mediated_rac_inhibition_magnitude', 4.75), ('max_force_rac', 0.1*10e3), ('eta', 0.1*1e5), ('randomization_time_mean', 40.0), ('randomization_time_variance_factor', 0.1), ('randomization_magnitude', 6.0), ('randomization_node_percentage', 0.25), ('stiffness_edge', 4000.)])
...
ets.two_cells_cil_test(date_str, experiment_number, sub_experiment_number, copy.deepcopy(parameter_dict), no_randomization=False, base_output_dir="A:\\numba-ncc\\output\\", total_time_in_hours=2., timestep_length=2, verbose=True, integration_params={'rtol': 1e-2}, max_timepoints_on_ram=max_timepoints_on_ram, seed=None, allowed_drift_before_geometry_recalc=allowed_drift_before_geometry_recalc, default_coa=16.0, default_cil=80.0, num_experiment_repeats=5, timesteps_between_generation_of_intermediate_visuals=None, produce_final_visuals=True, full_print=True, delete_and_rerun_experiments_without_stored_env=True, migr_bdry_height_factor=1.0, remake_visualizations=remake_visualizations)
...
parameter_dict.update([('kgtp_rac_multiplier', 1.75*10.0),
  ...
  ('threshold_rho_activity_multiplier', 0.2),
  ('kgtp_rac_autoact_multiplier', 250.0),
  ('kgtp_rho_autoact_multiplier', 0.3*250.0),
  ('kdgtp_rac_mediated_rho_inhib_multiplier', 2000.0),
  ('kdgtp_rho_mediated_rac_inhib_multiplier', 2000.0),
  ('tension_mediated_rac_inhibition_half_strain', 0.02), ('tension_mediated_rac_inhibition_magnitude', 4.75), ('max_force_rac', 0.1*10e3), ('eta', 0.1*1e5), ('randomization_time_mean', 40.0), ('randomization_time_variance_factor', 0.1), ('randomization_magnitude', 6.0), ('randomization_node_percentage', 0.25), ('stiffness_edge', 3500.)])
...
parameter_dict.update([('kgtp_rac_multiplier', 1.75*10.0),
  ...
  ('threshold_rho_activity_multiplier', 0.2),
  ('kgtp_rac_autoact_multiplier', 250.0),
  ('kgtp_rho_autoact_multiplier', 0.35*250.0),
  ('kdgtp_rac_mediated_rho_inhib_multiplier', 2000.0),
  ('kdgtp_rho_mediated_rac_inhib_multiplier', 2000.0),
  ('tension_mediated_rac_inhibition_half_strain', 0.02), ('tension_mediated_rac_inhibition_magnitude', 4.75), ('max_force_rac', 0.1*10e3), ('eta', 0.1*1e5), ('randomization_time_mean', 40.0), ('randomization_time_variance_factor', 0.1), ('randomization_magnitude', 6.0), ('randomization_node_percentage', 0.25), ('stiffness_edge', 3500.)])
...
parameter_dict.update([('kgtp_rac_multiplier', 1.75*10.0),
  ...
  ('threshold_rho_activity_multiplier', 0.2),
  ('kgtp_rac_autoact_multiplier', 250.0),
  ('kgtp_rho_autoact_multiplier', 0.4*250.0),
  ('kdgtp_rac_mediated_rho_inhib_multiplier', 2000.0),
  ('kdgtp_rho_mediated_rac_inhib_multiplier', 2000.0),
  ('tension_mediated_rac_inhibition_half_strain', 0.02), ('tension_mediated_rac_inhibition_magnitude', 4.75), ('max_force_rac', 0.1*10e3), ('eta', 0.1*1e5), ('randomization_time_mean', 40.0), ('randomization_time_variance_factor', 0.1), ('randomization_magnitude', 6.0), ('randomization_node_percentage', 0.25), ('stiffness_edge', 3500.)])
