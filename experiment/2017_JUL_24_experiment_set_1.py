...
#  ('kdgtp_rac_mediated_rho_inhib_multiplier', 200.0),
#  ('kdgtp_rho_mediated_rac_inhib_multiplier', 2000.0), ('tension_mediated_rac_inhibition_half_strain', 0.1),
#  ('tension_mediated_rac_inhibition_magnitude', 70.0),
#  ('max_force_rac', 3000.0),
#  ('eta', 2.9*10000.0),
#  ('stiffness_edge', 8000.0), ('randomization_time_mean', 20.0), ('randomization_time_variance_factor', 0.1), ('randomization_magnitude', 12.0), ('randomization_node_percentage', 0.25)])
#
...
#  ('kdgtp_rac_multiplier', 4.0),
#  ('kdgtp_rho_multiplier', 30.0),
#  ('kgtp_rac_autoact_multiplier', 1.05*250.0),
#  ('kgtp_rho_autoact_multiplier', 3*65.0),
#  ('kdgtp_rac_mediated_rho_inhib_multiplier', 200.0),
#  ('kdgtp_rho_mediated_rac_inhib_multiplier', 2000.0), ('tension_mediated_rac_inhibition_half_strain', 0.1),
#  ('tension_mediated_rac_inhibition_magnitude', 50.0),
...
#parameter_dict.update([('kgtp_rac_multiplier', 1.1*12.0),
#  ('kgtp_rho_multiplier', 14.0),
#  ('kdgtp_rac_multiplier', 4.0),
#  ('kdgtp_rho_multiplier', 30.0),
#  ('kgtp_rac_autoact_multiplier', 250.0),
...
#  ('kgtp_rho_autoact_multiplier', 3*65.0),
#  ('kdgtp_rac_mediated_rho_inhib_multiplier', 200.0),
#  ('kdgtp_rho_mediated_rac_inhib_multiplier', 2000.0), ('tension_mediated_rac_inhibition_half_strain', 0.9*0.1),
#  ('tension_mediated_rac_inhibition_magnitude', 50.0),
#  ('max_force_rac', 3000.0),
#  ('eta', 2.9*10000.0),
#  ('stiffness_edge', 8000.0), ('randomization_time_mean', 20.0), ('randomization_time_variance_factor', 0.1), ('randomization_magnitude', 12.0), ('randomization_node_percentage', 0.25)])
...
#  ('kgtp_rho_autoact_multiplier', 3*65.0),
#  ('kdgtp_rac_mediated_rho_inhib_multiplier', 200.0),
#  ('kdgtp_rho_mediated_rac_inhib_multiplier', 2000.0), ('tension_mediated_rac_inhibition_half_strain', 0.8*0.1),
#  ('tension_mediated_rac_inhibition_magnitude', 50.0),
#  ('max_force_rac', 3000.0),
#  ('eta', 2.9*10000.0),
#  ('stiffness_edge', 8000.0), ('randomization_time_mean', 20.0), ('randomization_time_variance_factor', 0.1), ('randomization_magnitude', 12.0), ('randomization_node_percentage', 0.25)])
...
#  ('kgtp_rho_autoact_multiplier', 3*65.0),
#  ('kdgtp_rac_mediated_rho_inhib_multiplier', 200.0),
#  ('kdgtp_rho_mediated_rac_inhib_multiplier', 2000.0), ('tension_mediated_rac_inhibition_half_strain', 0.7*0.1),
#  ('tension_mediated_rac_inhibition_magnitude', 50.0),
#  ('max_force_rac', 3000.0),
#  ('eta', 2.9*10000.0),
#  ('stiffness_edge', 8000.0), ('randomization_time_mean', 20.0), ('randomization_time_variance_factor', 0.1), ('randomization_magnitude', 12.0), ('randomization_node_percentage', 0.25)])
...
parameter_dict.update([('kgtp_rac_multiplier', 12.0),
  ...
  ('max_force_rac', 3000.0),
  ('eta', 2.9*10000.0),
  ('stiffness_edge', 0.9*8000.0), ('randomization_time_mean', 20.0), ('randomization_time_variance_factor', 0.1), ('randomization_magnitude', 12.0), ('randomization_node_percentage', 0.25)])
