...
parameter_dict.update([('kgtp_rac_multiplier', 39.0),
  ...
  ('kgtp_rac_autoact_multiplier', 295.0),
  ('kgtp_rho_autoact_multiplier', 126.0),
  ('kdgtp_rac_mediated_rho_inhib_multiplier', 400.0),
  ('kdgtp_rho_mediated_rac_inhib_multiplier', 1800.0),
  ('tension_mediated_rac_inhibition_half_strain', 0.079999999999999974),
