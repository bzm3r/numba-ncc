...
parameter_dict.update([('kgtp_rac_multiplier', 0.5*7.0),
 ('kgtp_rho_multiplier', 20.0),
 ('kdgtp_rac_multiplier', 1.0),
 ('kdgtp_rho_multiplier', 18.0),
 ('threshold_rac_activity_multiplier', 0.80),
...
ets.single_cell_polarization_test(date_str, experiment_number, 0, parameter_dict, randomization_scheme="m", randomization_magnitude_m=randomization_magnitude_m, randomization_time_mean_m=randomization_time_mean_m, randomization_time_variance_factor_m=randomization_time_variance_factor_m, randomization_time_mean_w=40.0, randomization_time_variance_factor_w=0.25, base_output_dir="A:\\numba-ncc\\output\\", total_time_in_hours=6., timestep_length=2, verbose=True, integration_params={'rtol': 1e-2, 'atol': 1e-16}, max_timepoints_on_ram=max_timepoints_on_ram, seed=None, allowed_drift_before_geometry_recalc=allowed_drift_before_geometry_recalc, default_coa=6.0, default_cil=40.0, num_experiment_repeats=50, timesteps_between_generation_of_intermediate_visuals=None, produce_final_visuals=True, full_print=True, delete_and_rerun_experiments_without_stored_env=True, justify_parameters=False)

parameter_dict.update([('kgtp_rac_multiplier', 0.4*7.0),
 ('kgtp_rho_multiplier', 20.0),
 ('kdgtp_rac_multiplier', 1.0),
 ('kdgtp_rho_multiplier', 18.0),
 ('threshold_rac_activity_multiplier', 0.80),
...
ets.single_cell_polarization_test(date_str, experiment_number, 1, parameter_dict, randomization_scheme="m", randomization_magnitude_m=randomization_magnitude_m, randomization_time_mean_m=randomization_time_mean_m, randomization_time_variance_factor_m=randomization_time_variance_factor_m, randomization_time_mean_w=40.0, randomization_time_variance_factor_w=0.25, base_output_dir="A:\\numba-ncc\\output\\", total_time_in_hours=6., timestep_length=2, verbose=True, integration_params={'rtol': 1e-2, 'atol': 1e-16}, max_timepoints_on_ram=max_timepoints_on_ram, seed=None, allowed_drift_before_geometry_recalc=allowed_drift_before_geometry_recalc, default_coa=6.0, default_cil=40.0, num_experiment_repeats=50, timesteps_between_generation_of_intermediate_visuals=None, produce_final_visuals=True, full_print=True, delete_and_rerun_experiments_without_stored_env=True, justify_parameters=False)
