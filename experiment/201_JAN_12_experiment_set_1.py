...
parameter_dict.update([('kgtp_rac_multiplier', 12.0),
  ...
  ('eta', 2.9*10000.0),
  ('stiffness_edge', 8000.0), ('randomization_time_mean', 20.0), ('randomization_time_variance_factor', 0.1), ('randomization_magnitude', 12.0), ('randomization_node_percentage', 0.25), ('chemoattractant_shielding_effect_length_squared', (40e-6)**2), ('chemoattractant_mediated_coa_dampening_factor', 0.0)])
...
if __name__ == '__main__':
  ...
  slope = 0.02 / 40.0
  x_offset_in_corrdior = 625.0
  parameter_dict.update([('chemoattractant_mediated_coa_dampening_factor', 0.0),])
  test_chemo_magnitudes = [0.0]

  ets.chemotaxis_threshold_test_magnitudes(
    date_str,
    experiment_number, sub_experiment_number,
    copy.deepcopy(parameter_dict),
    no_randomization=False, base_output_dir="B:\\numba-ncc\\output\\",
    total_time_in_hours=0.5, timestep_length=2, verbose=True,
    integration_params=integration_params, max_timepoints_on_ram=max_timepoints_on_ram,
    seed=None, allowed_drift_before_geometry_recalc=allowed_drift_before_geometry_recalc,
    test_x_offset_in_corridor=x_offset_in_corrdior,
    test_chemo_magnitudes=test_chemo_magnitudes, test_chemo_slope=slope, num_experiment_repeats=1,
    timesteps_between_generation_of_intermediate_visuals=None,
    produce_graphs=True, produce_animation=False,
