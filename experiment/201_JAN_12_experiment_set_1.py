...
if __name__ == "__main__":
    ...
    ets.chemotaxis_threshold_test_magnitudes(
        ...
        remake_graphs=False,
        remake_animation=False,
        default_coas=[coa_dict[16]] * len(test_chemo_magnitudes),
        default_cil=default_cil,
        chemotaxis_target_radius=160.0,
        box_y_placement_factor=0.5,
        num_cells=[16] * len(test_chemo_magnitudes),
        box_widths=[4] * len(test_chemo_magnitudes),
        box_heights=[4] * len(test_chemo_magnitudes),
    )
    #
