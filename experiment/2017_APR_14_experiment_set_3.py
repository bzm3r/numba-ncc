...
ets.single_cell_polarization_test(date_str, experiment_number, sub_experiment_number, copy.deepcopy(parameter_dict), no_randomization=False, base_output_dir="A:\\numba-ncc\\output\\", total_time_in_hours=4., timestep_length=2, verbose=True, integration_params={'rtol': 1e-2}, max_timepoints_on_ram=max_timepoints_on_ram, seed=None, allowed_drift_before_geometry_recalc=allowed_drift_before_geometry_recalc, default_coa=3.0, default_cil=40.0, num_experiment_repeats=20, timesteps_between_generation_of_intermediate_visuals=None, produce_final_visuals=True, full_print=True, delete_and_rerun_experiments_without_stored_env=True)
...
parameter_dict.update([('kgtp_rac_multiplier', 5.0),
  ...
  ('randomization_time_variance_factor', 0.1),
  ('randomization_magnitude', 15.0),
  ('stiffness_edge', 8000.0), ('randomization_node_percentage', 0.4), ('eta', 1e5)])
...
parameter_dict.update([('kgtp_rac_multiplier', 5.0),
  ...
  ('randomization_time_variance_factor', 0.1),
  ('randomization_magnitude', 10.0),
  ('stiffness_edge', 8000.0), ('randomization_node_percentage', 0.3), ('eta', 1e5)])
