...
parameter_dict = dict(
    [
        ...
        ("hill_exponent", 3),
        ("tension_mediated_rac_inhibition_half_strain", 0.025),
        ("max_coa_signal", -1),
...
parameter_dict.update(
    [
        ("kgtp_rac_multiplier", 1),
        ("kgtp_rho_multiplier", 4),
        ("kdgtp_rac_multiplier", 1),
        ("kdgtp_rho_multiplier", 10),
        ("threshold_rac_activity_multiplier", 0.15000000000000002),
        ("threshold_rho_activity_multiplier", 0.8),
        ("kgtp_rac_autoact_multiplier", 750),
        ("kgtp_rho_autoact_multiplier", 500),
        ("kdgtp_rac_mediated_rho_inhib_multiplier", 700),
        ("kdgtp_rho_mediated_rac_inhib_multiplier", 525),
    ]
)
