...
parameter_dict.update([('kgtp_rac_multiplier', 12.0),
  ...
  ('enable_chemoattractant_shielding_effect', False),('chemoattractant_shielding_effect_length_squared', (40e-6)**2), ('chemoattractant_mediated_coa_dampening_factor', 0.0)])
...
if __name__ == '__main__':
  ...
  slope = 0.02 / 40.0
  x_offset_in_corrdior = 625.0
  parameter_dict.update([('chemoattractant_mediated_coa_dampening_factor', 0.0), ('enable_chemoattractant_shielding_effect', True)])
  test_chemo_magnitudes = [1.75]

  M = 4
  N = 5
  ets.chemotaxis_threshold_test_magnitudes(date_str, experiment_number, sub_experiment_number, copy.deepcopy(parameter_dict), no_randomization=False, base_output_dir="B:\\numba-ncc\\output\\", total_time_in_hours=10., timestep_length=2, verbose=True, integration_params=integration_params, max_timepoints_on_ram=max_timepoints_on_ram, seed=None, allowed_drift_before_geometry_recalc=allowed_drift_before_geometry_recalc, test_x_offset_in_corridor=x_offset_in_corrdior, test_chemo_magnitudes=test_chemo_magnitudes, test_chemo_slope=slope, num_experiment_repeats=3, timesteps_between_generation_of_intermediate_visuals=None, produce_graphs=True, produce_animation=True, full_print=True, delete_and_rerun_experiments_without_stored_env=True, run_experiments=True, remake_graphs=False, remake_animation=True, default_coas=[coa_dict[1], coa_dict[2], coa_dict[4], coa_dict[9], coa_dict[16]][M:N], default_cil=default_cil, chemotaxis_target_radius=160.0, box_y_placement_factor=0.5, num_cells=[1, 2,
    4, 9,
    16][M:N],
    box_widths=[1, 2, 2,
    3, 4][M:N],
