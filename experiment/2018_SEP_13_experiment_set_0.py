...
parameter_dict.update([('kgtp_rac_multiplier', 12.0),
  ...
  ('eta', 2.9*10000.0),
  ('stiffness_edge', 8000.0), ('randomization_time_mean', 20.0), ('randomization_time_variance_factor', 0.1), ('randomization_magnitude', 24.0), ('randomization_node_percentage', 0.25)])
