...
parameter_dict.update([('kgtp_rac_multiplier', 1.0),
  ...
  ('kdgtp_rho_mediated_rac_inhib_multiplier', 1100.0),
  ('tension_mediated_rac_inhibition_half_strain', 0.095000000000000001),
  ('stiffness_edge', 4000.0), ('randomization_time_mean', 20.0), ('randomization_time_variance_factor', 0.1), ('randomization_magnitude', 20.0), ('randomization_node_percentage', 0.25)])
...
parameter_dict.update([('kgtp_rac_multiplier', 1.0),
  ...
  ('kdgtp_rho_mediated_rac_inhib_multiplier', 1100.0),
  ('tension_mediated_rac_inhibition_half_strain', 0.095000000000000001),
  ('stiffness_edge', 4000.0), ('randomization_time_mean', 20.0), ('randomization_time_variance_factor', 0.1), ('randomization_magnitude', 50.0), ('randomization_node_percentage', 0.25)])
