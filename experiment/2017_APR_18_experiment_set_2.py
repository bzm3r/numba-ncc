...
parameter_dict.update([('kgtp_rac_multiplier', 11.0),
  ('kgtp_rho_multiplier', 39.0),
  ('kdgtp_rac_multiplier', 18.0),
  ('kdgtp_rho_multiplier', 40.0),
  ('threshold_rac_activity_multiplier', 0.50000000000000022),
  ('threshold_rho_activity_multiplier', 0.35000000000000009),
  ('kgtp_rac_autoact_multiplier', 216.0),
  ('kgtp_rho_autoact_multiplier', 261.0),
...
parameter_dict.update([('kgtp_rac_multiplier', 11.0),
  ...
  ('kdgtp_rho_mediated_rac_inhib_multiplier', 1000.0),
  ('tension_mediated_rac_inhibition_half_strain', 0.085000000000000006),
  ('stiffness_edge', 8000.0), ('randomization_magnitude', 5.0), ('randomization_time_mean', 40.0), ('randomization_time_variance_factor', 0.1), ('randomization_node_percentage', 0.45)])

sub_experiment_number = 1

ets.single_cell_polarization_test(date_str, experiment_number, sub_experiment_number, copy.deepcopy(parameter_dict), no_randomization=False, base_output_dir="A:\\numba-ncc\\output\\", total_time_in_hours=6., timestep_length=2, verbose=True, integration_params={'rtol': 1e-2}, max_timepoints_on_ram=max_timepoints_on_ram, seed=None, allowed_drift_before_geometry_recalc=allowed_drift_before_geometry_recalc, default_coa=4.0, default_cil=80.0, num_experiment_repeats=1, timesteps_between_generation_of_intermediate_visuals=None, produce_final_visuals=True, full_print=True, delete_and_rerun_experiments_without_stored_env=True)

#ets.single_cell_polarization_test(date_str, experiment_number, sub_experiment_number, copy.deepcopy(parameter_dict), no_randomization=False, base_output_dir="A:\\numba-ncc\\output\\", total_time_in_hours=1., timestep_length=2, verbose=True, integration_params={'rtol': 1e-2}, max_timepoints_on_ram=max_timepoints_on_ram, seed=None, allowed_drift_before_geometry_recalc=allowed_drift_before_geometry_recalc, default_coa=4.0, default_cil=80.0, num_experiment_repeats=1, timesteps_between_generation_of_intermediate_visuals=None, produce_final_visuals=True, full_print=True, delete_and_rerun_experiments_without_stored_env=True)
