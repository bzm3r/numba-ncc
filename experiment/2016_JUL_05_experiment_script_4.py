...
plate_width, plate_height = 1500, (box_heights[0] + physical_bdry_polygon_extra*2)*2.4

x_space_between_boxes = [2*CELL_DIAMETER, 2*CELL_DIAMETER, 2*CELL_DIAMETER]

x_offset, y_offset = 10, 10#0.5*(plate_width - 0.5*box_widths[1]), 0.5*(plate_height - 0.5*box_heights[1])
