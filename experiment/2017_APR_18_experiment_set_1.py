...
parameter_dict.update([('kgtp_rac_multiplier', 10.0),
  ...
  ('threshold_rac_activity_multiplier', 0.34999999999999998),
  ('threshold_rho_activity_multiplier', 0.75),
  ('kgtp_rac_autoact_multiplier', 290.0),
  ('kgtp_rho_autoact_multiplier', 300.0),
  ...
  ('stiffness_edge', 6000.0), ('randomization_magnitude', 10.0), ('randomization_time_mean', 40.0), ('randomization_time_variance_factor', 0.1), ('randomization_node_percentage', 0.45)])
