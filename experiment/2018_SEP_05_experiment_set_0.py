...
if __name__ == '__main__':
  ...
  #
  # chm = 0.0
  # ets.no_corridor_chemoattraction_test(date_str, experiment_number, sub_experiment_number, parameter_dict, {'source_type': 'linear', 'x_offset_in_corridor': x_offset_in_corrdior, 'max_value': chm, 'slope': slope}, no_randomization=False, base_output_dir="B:\\numba-ncc\\output\\", total_time_in_hours=10., timestep_length=2, verbose=True, integration_params=integration_params, max_timepoints_on_ram=10, seed=None, allowed_drift_before_geometry_recalc=allowed_drift_before_geometry_recalc, timesteps_between_generation_of_intermediate_visuals=None, num_experiment_repeats=20, produce_graphs=True, produce_animation=True, full_print=True, delete_and_rerun_experiments_without_stored_env=True, run_experiments=True, remake_graphs=True, remake_animation=False, default_coa=coa_dict[4], default_cil=default_cil, chemotaxis_target_radius=160.0, box_width=2, box_height=2, box_y_placement_factor=0.5, num_cells=4)

  import time

  #[2., 2.25, 2.5, 2.75, 3., 3.25, 3.5, 3.75, 4.0]
  st = time.time()
  ets.chemotaxis_threshold_test_magnitudes(date_str, experiment_number, sub_experiment_number, copy.deepcopy(parameter_dict), no_randomization=False, base_output_dir="B:\\numba-ncc\\output\\", total_time_in_hours=10., timestep_length=2, verbose=True, integration_params=integration_params, max_timepoints_on_ram=10, seed=None, allowed_drift_before_geometry_recalc=allowed_drift_before_geometry_recalc, test_x_offset_in_corridor=x_offset_in_corrdior, test_chemo_magnitudes=[2.75], test_chemo_slope=slope, num_experiment_repeats=100, timesteps_between_generation_of_intermediate_visuals=None, produce_graphs=True, produce_animation=True, full_print=True, delete_and_rerun_experiments_without_stored_env=True, run_experiments=True, remake_graphs=False, remake_animation=True, default_coa=coa_dict[2], default_cil=default_cil, chemotaxis_target_radius=160.0, box_width=2, box_height=1, box_y_placement_factor=0.5, num_cells=2)
  et = time.time()
