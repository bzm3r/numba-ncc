...
ets.chemoattractant_test(
    ...
    num_cells_height=3,
    num_cells=1,
    migratory_box_width=1000,
    migratory_box_height=400,
    auto_calculate_num_cells=False,
    chemoattractant_source_definition=[500.0, 0.0, 1000.0, 0.0, 1.0],
    autocalculate_chemoattractant_source_y_position=True,
...
ets.chemoattractant_test(
    ...
    migratory_box_height=400,
    auto_calculate_num_cells=False,
    chemoattractant_source_definition=[500.0, 0.0, 1000.0, 0.0, 2.0],
    autocalculate_chemoattractant_source_y_position=True,
    remake_visualizations=remake_visualizations,
)
