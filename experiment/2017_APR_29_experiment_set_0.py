...
parameter_dict.update([('kgtp_rac_multiplier', 1.75*10.0),
  ...
  ('kgtp_rho_autoact_multiplier', 0.45*250.0),
  ('kdgtp_rac_mediated_rho_inhib_multiplier', 200.0),
  ('kdgtp_rho_mediated_rac_inhib_multiplier', 2000.0),
  ('tension_mediated_rac_inhibition_half_strain', 0.02), ('tension_mediated_rac_inhibition_magnitude', 4.75), ('max_force_rac', 0.1*10e3), ('eta', 0.1*1e5), ('randomization_time_mean', 40.0), ('randomization_time_variance_factor', 0.1), ('randomization_magnitude', 6.0), ('randomization_node_percentage', 0.25), ('stiffness_edge', 3500.)])
...
parameter_dict.update([('kgtp_rac_multiplier', 1.75*10.0),
  ...
  ('kdgtp_rac_mediated_rho_inhib_multiplier', 200.0),
  ('kdgtp_rho_mediated_rac_inhib_multiplier', 2000.0),
  ('tension_mediated_rac_inhibition_half_strain', 0.02), ('tension_mediated_rac_inhibition_magnitude', 4.75), ('max_force_rac', 0.1*10e3), ('eta', 0.1*1e5), ('randomization_time_mean', 40.0), ('randomization_time_variance_factor', 0.1), ('randomization_magnitude', 6.0), ('randomization_node_percentage', 0.25), ('stiffness_edge', 2500.)])
...
parameter_dict.update([('kgtp_rac_multiplier', 1.75*10.0),
  ...
  ('kdgtp_rac_mediated_rho_inhib_multiplier', 200.0),
  ('kdgtp_rho_mediated_rac_inhib_multiplier', 2000.0),
  ('tension_mediated_rac_inhibition_half_strain', 0.05), ('tension_mediated_rac_inhibition_magnitude', 4.75), ('max_force_rac', 0.1*10e3), ('eta', 0.1*1e5), ('randomization_time_mean', 40.0), ('randomization_time_variance_factor', 0.1), ('randomization_magnitude', 6.0), ('randomization_node_percentage', 0.25), ('stiffness_edge', 2500.)])
...
parameter_dict.update([('kgtp_rac_multiplier', 1.75*10.0),
  ...
  ('threshold_rac_activity_multiplier', 0.2),
  ('threshold_rho_activity_multiplier', 0.2),
  ('kgtp_rac_autoact_multiplier', 1.25*250.0),
  ('kgtp_rho_autoact_multiplier', 0.45*250.0),
  ('kdgtp_rac_mediated_rho_inhib_multiplier', 200.0),
  ('kdgtp_rho_mediated_rac_inhib_multiplier', 2000.0),
  ('tension_mediated_rac_inhibition_half_strain', 0.05), ('tension_mediated_rac_inhibition_magnitude', 4.75), ('max_force_rac', 0.1*10e3), ('eta', 0.1*1e5), ('randomization_time_mean', 40.0), ('randomization_time_variance_factor', 0.1), ('randomization_magnitude', 6.0), ('randomization_node_percentage', 0.25), ('stiffness_edge', 2500.)])
...
parameter_dict.update([('kgtp_rac_multiplier', 2.0*10.0),
  ('kgtp_rho_multiplier', 10.0),
  ('kdgtp_rac_multiplier', 1.5*10.),
  ('kdgtp_rho_multiplier', 3.5*10.0),
  ('threshold_rac_activity_multiplier', 0.2),
...
parameter_dict.update([('kgtp_rac_multiplier', 1.8*10.0),
  ...
  ('threshold_rac_activity_multiplier', 0.2),
  ('threshold_rho_activity_multiplier', 0.2),
  ('kgtp_rac_autoact_multiplier', 0.9*250.0),
  ('kgtp_rho_autoact_multiplier', 0.45*250.0),
  ('kdgtp_rac_mediated_rho_inhib_multiplier', 200.0),
  ('kdgtp_rho_mediated_rac_inhib_multiplier', 2000.0),
  ('tension_mediated_rac_inhibition_half_strain', 0.05), ('tension_mediated_rac_inhibition_magnitude', 4.75), ('max_force_rac', 0.1*10e3), ('eta', 0.1*1e5), ('randomization_time_mean', 40.0), ('randomization_time_variance_factor', 0.1), ('randomization_magnitude', 6.0), ('randomization_node_percentage', 0.25), ('stiffness_edge', 2500.)])
...
parameter_dict.update([('kgtp_rac_multiplier', 1.8*10.0),
  ...
  ('kdgtp_rac_mediated_rho_inhib_multiplier', 200.0),
  ('kdgtp_rho_mediated_rac_inhib_multiplier', 2000.0),
  ('tension_mediated_rac_inhibition_half_strain', 0.05), ('tension_mediated_rac_inhibition_magnitude', 5.0), ('max_force_rac', 0.1*10e3), ('eta', 0.1*1e5), ('randomization_time_mean', 40.0), ('randomization_time_variance_factor', 0.1), ('randomization_magnitude', 6.0), ('randomization_node_percentage', 0.25), ('stiffness_edge', 2500.)])
...
parameter_dict.update([('kgtp_rac_multiplier', 1.8*10.0),
  ...
  ('kdgtp_rac_mediated_rho_inhib_multiplier', 200.0),
  ('kdgtp_rho_mediated_rac_inhib_multiplier', 2000.0),
  ('tension_mediated_rac_inhibition_half_strain', 0.05), ('tension_mediated_rac_inhibition_magnitude', 5.5), ('max_force_rac', 0.1*10e3), ('eta', 0.1*1e5), ('randomization_time_mean', 40.0), ('randomization_time_variance_factor', 0.1), ('randomization_magnitude', 6.0), ('randomization_node_percentage', 0.25), ('stiffness_edge', 2500.)])
...
parameter_dict.update([('kgtp_rac_multiplier', 1.8*10.0),
  ...
  ('kdgtp_rac_mediated_rho_inhib_multiplier', 200.0),
  ('kdgtp_rho_mediated_rac_inhib_multiplier', 2000.0),
  ('tension_mediated_rac_inhibition_half_strain', 0.05), ('tension_mediated_rac_inhibition_magnitude', 6.0), ('max_force_rac', 0.1*10e3), ('eta', 0.1*1e5), ('randomization_time_mean', 40.0), ('randomization_time_variance_factor', 0.1), ('randomization_magnitude', 6.0), ('randomization_node_percentage', 0.25), ('stiffness_edge', 2500.)])
...
parameter_dict.update([('kgtp_rac_multiplier', 1.8*10.0),
  ...
  ('kdgtp_rac_mediated_rho_inhib_multiplier', 200.0),
  ('kdgtp_rho_mediated_rac_inhib_multiplier', 2000.0),
  ('tension_mediated_rac_inhibition_half_strain', 0.05), ('tension_mediated_rac_inhibition_magnitude', 6.5), ('max_force_rac', 0.1*10e3), ('eta', 0.1*1e5), ('randomization_time_mean', 40.0), ('randomization_time_variance_factor', 0.1), ('randomization_magnitude', 6.0), ('randomization_node_percentage', 0.25), ('stiffness_edge', 2500.)])
...
parameter_dict.update([('kgtp_rac_multiplier', 1.8*10.0),
  ...
  ('kdgtp_rac_mediated_rho_inhib_multiplier', 200.0),
  ('kdgtp_rho_mediated_rac_inhib_multiplier', 2000.0),
  ('tension_mediated_rac_inhibition_half_strain', 0.05), ('tension_mediated_rac_inhibition_magnitude', 6.25), ('max_force_rac', 0.1*10e3), ('eta', 0.1*1e5), ('randomization_time_mean', 40.0), ('randomization_time_variance_factor', 0.1), ('randomization_magnitude', 6.0), ('randomization_node_percentage', 0.25), ('stiffness_edge', 2500.)])

sub_experiment_number = 12

ets.single_cell_polarization_test(date_str, experiment_number, sub_experiment_number, copy.deepcopy(parameter_dict), no_randomization=True, base_output_dir="A:\\numba-ncc\\output\\", total_time_in_hours=2., timestep_length=2, verbose=True, integration_params={'rtol': 1e-2}, max_timepoints_on_ram=max_timepoints_on_ram, seed=None, allowed_drift_before_geometry_recalc=allowed_drift_before_geometry_recalc, default_coa=4.0, default_cil=80.0, num_experiment_repeats=3, timesteps_between_generation_of_intermediate_visuals=None, produce_final_visuals=True, full_print=True, delete_and_rerun_experiments_without_stored_env=True, remake_visualizations=remake_visualizations)
...
parameter_dict.update([('kgtp_rac_multiplier', 1.8*10.0),
  ...
  ('threshold_rac_activity_multiplier', 0.2),
  ('threshold_rho_activity_multiplier', 0.2),
  ('kgtp_rac_autoact_multiplier', 0.5*250.0),
  ('kgtp_rho_autoact_multiplier', 0.45*250.0),
  ('kdgtp_rac_mediated_rho_inhib_multiplier', 200.0),
  ('kdgtp_rho_mediated_rac_inhib_multiplier', 2000.0),
  ('tension_mediated_rac_inhibition_half_strain', 0.05), ('tension_mediated_rac_inhibition_magnitude', 5.5), ('max_force_rac', 0.1*10e3), ('eta', 0.1*1e5), ('randomization_time_mean', 40.0), ('randomization_time_variance_factor', 0.1), ('randomization_magnitude', 6.0), ('randomization_node_percentage', 0.25), ('stiffness_edge', 2500.)])
...
parameter_dict.update([('kgtp_rac_multiplier', 1.8*10.0),
  ...
  ('kdgtp_rac_mediated_rho_inhib_multiplier', 200.0),
  ('kdgtp_rho_mediated_rac_inhib_multiplier', 2000.0),
  ('tension_mediated_rac_inhibition_half_strain', 0.05), ('tension_mediated_rac_inhibition_magnitude', 5.5), ('max_force_rac', 0.1*10e3), ('eta', 0.1*1e5), ('randomization_time_mean', 40.0), ('randomization_time_variance_factor', 0.1), ('randomization_magnitude', 4.0), ('randomization_node_percentage', 0.25), ('stiffness_edge', 2500.)])
...
parameter_dict.update([('kgtp_rac_multiplier', 1.8*10.0),
  ...
  ('kdgtp_rac_mediated_rho_inhib_multiplier', 200.0),
  ('kdgtp_rho_mediated_rac_inhib_multiplier', 2000.0),
  ('tension_mediated_rac_inhibition_half_strain', 0.05), ('tension_mediated_rac_inhibition_magnitude', 5.5), ('max_force_rac', 0.1*10e3), ('eta', 0.1*1e5), ('randomization_time_mean', 40.0), ('randomization_time_variance_factor', 0.1), ('randomization_magnitude', 3.0), ('randomization_node_percentage', 0.25), ('stiffness_edge', 2500.)])
...
parameter_dict.update([('kgtp_rac_multiplier', 1.8*10.0),
  ...
  ('kdgtp_rac_mediated_rho_inhib_multiplier', 200.0),
  ('kdgtp_rho_mediated_rac_inhib_multiplier', 2000.0),
  ('tension_mediated_rac_inhibition_half_strain', 0.05), ('tension_mediated_rac_inhibition_magnitude', 6.0), ('max_force_rac', 0.1*10e3), ('eta', 0.1*1e5), ('randomization_time_mean', 40.0), ('randomization_time_variance_factor', 0.1), ('randomization_magnitude', 4.0), ('randomization_node_percentage', 0.25), ('stiffness_edge', 2500.)])
