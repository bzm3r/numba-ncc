...
if __name__ == "__main__":
  ...
  ('tension_mediated_rac_inhibition_magnitude', 25.0),
  ('max_force_rac', 3000.0),
  ('eta', 2.9*10000.0),
  ('stiffness_edge', 7000.0), ('randomization_time_mean', 10.0), ('randomization_time_variance_factor', 0.1), ('randomization_magnitude', 16.0), ('randomization_node_percentage', 0.25), ('threshold_rac_activity_multiplier', 0.2)])
