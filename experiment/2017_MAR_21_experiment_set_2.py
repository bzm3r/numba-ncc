...
parameter_dict.update(
    [
        ...
        ("kgtp_rho_multiplier", 2),
        ("kdgtp_rac_multiplier", 2),
        ("kdgtp_rho_multiplier", 6),
        ("threshold_rac_activity_multiplier", 0.10000000000000001),
        ("threshold_rho_activity_multiplier", 0.69999999999999996),
        ("kgtp_rac_autoact_multiplier", 600),
        ("kgtp_rho_autoact_multiplier", 400),
        ("kdgtp_rac_mediated_rho_inhib_multiplier", 375),
        ("kdgtp_rho_mediated_rac_inhib_multiplier", 925),
    ]
)
