...
plate_width, plate_height = 1000, 1000#1.2*(box_widths[0] + physical_bdry_polygon_extra*2 + 10), 1.2*(box_heights[0] + physical_bdry_polygon_extra*2 + 10)#1500, (box_heights[0] + physical_bdry_polygon_extra*2)*2
