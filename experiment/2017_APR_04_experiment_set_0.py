...
parameter_dict.update([('kgtp_rac_multiplier', 398.0),
  ('kgtp_rho_multiplier', 70.0),
  ('kdgtp_rac_multiplier', 130.0),
  ('kdgtp_rho_multiplier', 36.0),
  ('threshold_rac_activity_multiplier', 0.26999999999999996),
  ('threshold_rho_activity_multiplier', 0.72000000000000008),
  ('kgtp_rac_autoact_multiplier', 76.0),
  ('kgtp_rho_autoact_multiplier', 821.0),
  ('kdgtp_rac_mediated_rho_inhib_multiplier', 945.0),
  ('kdgtp_rho_mediated_rac_inhib_multiplier', 1513.0),
  ('tension_mediated_rac_inhibition_half_strain', 0.5),
  ('stiffness_edge', 8000),
  ('max_force_rac', 50000.0),
  ('eta', 25000.0)])


sub_experiment_number = 0

ets.single_cell_polarization_test(date_str, experiment_number, 0, parameter_dict, randomization_scheme=None, randomization_magnitude_m=0.0, randomization_time_mean_m=randomization_time_mean_m, randomization_time_variance_factor_m=randomization_time_variance_factor_m, randomization_time_mean_w=30.0, randomization_time_variance_factor_w=0.25, base_output_dir="A:\\numba-ncc\\output\\", total_time_in_hours=6., timestep_length=2, verbose=True, integration_params={'rtol': 1e-2}, max_timepoints_on_ram=max_timepoints_on_ram, seed=seed, allowed_drift_before_geometry_recalc=allowed_drift_before_geometry_recalc, default_coa=6.0, default_cil=40.0, num_experiment_repeats=1, timesteps_between_generation_of_intermediate_visuals=None, produce_final_visuals=True, full_print=True, delete_and_rerun_experiments_without_stored_env=True)

ets.single_cell_polarization_test(date_str, experiment_number, 0, parameter_dict, randomization_scheme="m", randomization_magnitude_m=6.0, randomization_time_mean_m=randomization_time_mean_m, randomization_time_variance_factor_m=randomization_time_variance_factor_m, randomization_time_mean_w=30.0, randomization_time_variance_factor_w=0.25, base_output_dir="A:\\numba-ncc\\output\\", total_time_in_hours=6., timestep_length=2, verbose=True, integration_params={'rtol': 1e-2}, max_timepoints_on_ram=max_timepoints_on_ram, seed=seed, allowed_drift_before_geometry_recalc=allowed_drift_before_geometry_recalc, default_coa=6.0, default_cil=40.0, num_experiment_repeats=1, timesteps_between_generation_of_intermediate_visuals=None, produce_final_visuals=True, full_print=True, delete_and_rerun_experiments_without_stored_env=True)
