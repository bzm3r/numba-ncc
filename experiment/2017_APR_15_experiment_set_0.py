...
parameter_dict.update([('kgtp_rac_multiplier', 31.0),
  ('kgtp_rho_multiplier', 11.0),
  ('kdgtp_rac_multiplier', 19.0),
  ('kdgtp_rho_multiplier', 33.0),
  ('threshold_rac_activity_multiplier', 0.59999999999999998),
  ('threshold_rho_activity_multiplier', 0.25000000000000006),
  ('kgtp_rac_autoact_multiplier', 296.0),
  ('kgtp_rho_autoact_multiplier', 236.0),
  ('kdgtp_rac_mediated_rho_inhib_multiplier', 500.0),
  ('kdgtp_rho_mediated_rac_inhib_multiplier', 1300.0),
  ('tension_mediated_rac_inhibition_half_strain', 0.039999999999999994),
