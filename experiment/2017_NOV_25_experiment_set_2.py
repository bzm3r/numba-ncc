...
hypo_set = dict([('kgtp_rac_multiplier', 12.0*0.1),
...
standard_set = dict([('kgtp_rac_multiplier', 12.0),
...
hyper_set = dict([('kgtp_rac_multiplier', 12.0*10),
...
parameter_update_dicts = [copy.deepcopy(standard_set), hypo_set, standard_set, hyper_set] 
...
ets.corridor_migration_parameter_set_test(date_str, experiment_number, parameter_dict, experiment_set_label="hypo_hyper_stand", no_randomization=False, base_output_dir="B:\\numba-ncc\\output\\", total_time_in_hours=20, timestep_length=2, verbose=True, closeness_dist_squared_criteria=closeness_dist_squared_criteria, integration_params=integration_params, max_timepoints_on_ram=max_timepoints_on_ram, seed=None, allowed_drift_before_geometry_recalc=allowed_drift_before_geometry_recalc, labels=labels, sub_experiment_numbers=[3, 0, 1, 2], parameter_update_dicts=parameter_update_dicts, default_coas=default_coas, default_cils=default_cils, num_cells=4, box_height=1, box_width=4, corridor_height=1, num_experiment_repeats=20, particular_repeats=[], timesteps_between_generation_of_intermediate_visuals=None, produce_final_visuals=True, full_print=True, delete_and_rerun_experiments_without_stored_env=True, run_experiments=False, remake_graphs=False, remake_animation=False, do_final_analysis=True, justify_parameters=False)
