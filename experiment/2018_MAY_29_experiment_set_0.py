...
if __name__ == "__main__":
    ...
    #ets.no_corridor_chemoattraction_test(date_str, experiment_number, sub_experiment_number, copy.deepcopy(parameter_dict), {'source_type': 'linear', 'x_offset_in_corridor': 625.0, 'max_value': 1.0, 'slope': 1.0/(2*625.0)}, no_randomization=False, base_output_dir="B:\\numba-ncc\\output\\", total_time_in_hours=6., timestep_length=2, verbose=True, integration_params=integration_params, max_timepoints_on_ram=max_timepoints_on_ram, seed=None, allowed_drift_before_geometry_recalc=allowed_drift_before_geometry_recalc, default_coa=coa_dict[1], default_cil=60.0, num_experiment_repeats=3, timesteps_between_generation_of_intermediate_visuals=None, produce_final_visuals=True, full_print=True, delete_and_rerun_experiments_without_stored_env=True, box_width=1, box_height=1, num_cells=1, box_y_placement_factor=0.5, remake_graphs=False, remake_animation=True, do_final_analysis=True, show_coa_overlay=False, coa_overlay_resolution=2, chemotaxis_target_radius=240.0)
    
    
    #ets.chemotaxis_threshold_test(date_str, experiment_number, sub_experiment_number, copy.deepcopy(parameter_dict), no_randomization=False, base_output_dir="B:\\numba-ncc\\output\\", total_time_in_hours=6., timestep_length=2, verbose=True, integration_params=integration_params, max_timepoints_on_ram=max_timepoints_on_ram, seed=None, allowed_drift_before_geometry_recalc=allowed_drift_before_geometry_recalc, test_x_offset_in_corridor=625.0, test_chemo_magnitudes=np.round(np.linspace(0, 1.0, num=11), decimals=1), test_chemo_slope=1.0/(2*625.0), default_coa=coa_dict[1], default_cil=60.0, num_experiment_repeats=10, timesteps_between_generation_of_intermediate_visuals=None, produce_final_visuals=True, full_print=True, delete_and_rerun_experiments_without_stored_env=True, remake_graphs=False, remake_animation=False, chemotaxis_target_radius=200.0, box_width=2, box_height=1, num_cells=2, box_y_placement_factor=0.5)
    
    ets.chemotaxis_threshold_test(date_str, experiment_number, sub_experiment_number, copy.deepcopy(parameter_dict), no_randomization=False, base_output_dir="B:\\numba-ncc\\output\\", total_time_in_hours=6., timestep_length=2, verbose=True, integration_params=integration_params, max_timepoints_on_ram=max_timepoints_on_ram, seed=None, allowed_drift_before_geometry_recalc=allowed_drift_before_geometry_recalc, test_x_offset_in_corridor=625.0, test_chemo_magnitudes=[0., .1, .2, 0.3, 0.4, .5], test_chemo_slope=1.0/(2*625.0), default_coa=coa_dict[4], default_cil=60.0, num_experiment_repeats=10, timesteps_between_generation_of_intermediate_visuals=None, produce_final_visuals=True, full_print=True, delete_and_rerun_experiments_without_stored_env=True, remake_graphs=False, remake_animation=False, chemotaxis_target_radius=300.0, box_width=2, box_height=2, num_cells=4, box_y_placement_factor=0.5)
#    
#    ets.two_cell_chemotaxis_threshold_test(date_str, experiment_number, sub_experiment_number, copy.deepcopy(parameter_dict), no_randomization=False, base_output_dir="B:\\numba-ncc\\output\\", total_time_in_hours=9., timestep_length=2, verbose=True, integration_params=integration_params, max_timepoints_on_ram=max_timepoints_on_ram, seed=None, allowed_drift_before_geometry_recalc=allowed_drift_before_geometry_recalc, test_x_offset_in_corridor=625.0, test_chemo_magnitudes=np.linspace(0.0, 1.0, num=10), test_chemo_slope=1.0/(2*625.0), default_coa=coa_dict[1], default_cil=60.0, num_experiment_repeats=10, timesteps_between_generation_of_intermediate_visuals=None, produce_final_visuals=True, full_print=True, delete_and_rerun_experiments_without_stored_env=True, remake_graphs=False, remake_animation=False)
