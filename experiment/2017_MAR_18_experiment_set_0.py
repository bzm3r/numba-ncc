...
parameter_dict = dict(
    [
        ...
        ("kgdi_multiplier", 1),
        ("kdgdi_multiplier", 1),
        ("kgtp_rac_multiplier", 60),
        ("kgtp_rac_autoact_multiplier", 185),
        ("kdgtp_rac_multiplier", 1),
        ("kdgtp_rho_mediated_rac_inhib_multiplier", 830),
        ("threshold_rac_activity_multiplier", 0.47),
        ("kgtp_rho_multiplier", 1.0),
        ("kgtp_rho_autoact_multiplier", 107),
        ("kdgtp_rho_multiplier", 1),
        ("kdgtp_rac_mediated_rho_inhib_multiplier", 1405),
        ("threshold_rho_activity_multiplier", 0.52),
        ("hill_exponent", 3),
