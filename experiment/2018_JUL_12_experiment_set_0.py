...
if __name__ == "__main__":
  ...
  ('kgtp_rac_autoact_multiplier', 0.4*250.0),
  ('kgtp_rho_autoact_multiplier', 0.4*195.0),
  ...
  ('eta', 2.9*10000.0),
  ('stiffness_edge', 8000.0), ('randomization_time_mean', 20.0), ('randomization_time_variance_factor', 0.1), ('randomization_magnitude', (8.0/12.0)*12.0), ('randomization_node_percentage', 0.25), ('kdgdi_rac_auto_factor', 2), ('kdgdi_rho_auto_factor', 2)])
