...
if __name__ == "__main__":
  ...
  ('eta', 2.9*10000.0),
  ('stiffness_edge', 8000.0), ('randomization_time_mean', 20.0), ('randomization_time_variance_factor', 0.1), ('randomization_magnitude', 12.0), ('randomization_node_percentage', 0.25), ('kdgdi_rac_auto_factor', 2), ('kdgdi_rho_auto_factor', 2)])
...
#    
    ...
    ets.no_corridor_chemoattraction_test(date_str, experiment_number, sub_experiment_number, copy.deepcopy(parameter_dict), {'source_type': 'normal', 'x_offset_in_corridor': 625.0 + 40.0, 'gaussian_width': 625.0, 'gaussian_height': 0.0}, no_randomization=False, base_output_dir="B:\\numba-ncc\\output\\", total_time_in_hours=6., timestep_length=2, verbose=True, integration_params=integration_params, max_timepoints_on_ram=max_timepoints_on_ram, seed=2039467, allowed_drift_before_geometry_recalc=allowed_drift_before_geometry_recalc, default_coa=coa_dict[2], default_cil=default_cil, num_experiment_repeats=1, timesteps_between_generation_of_intermediate_visuals=None, produce_final_visuals=True, full_print=True, delete_and_rerun_experiments_without_stored_env=True, box_width=2, box_height=1, num_cells=2, box_y_placement_factor=0.5, remake_graphs=True, remake_animation=False, do_final_analysis=True, show_coa_overlay=False, coa_overlay_resolution=2)
    
    #ets.chemotaxis_threshold_test(date_str, experiment_number, sub_experiment_number, copy.deepcopy(parameter_dict), no_randomization=False, base_output_dir="B:\\numba-ncc\\output\\", total_time_in_hours=6., timestep_length=2, verbose=True, integration_params=integration_params, max_timepoints_on_ram=10, seed=None, allowed_drift_before_geometry_recalc=allowed_drift_before_geometry_recalc, te74st_x_offset_in_corridor=625.0, test_chemo_magnitudes=[3.25, 3.5, 3.75, 4.0], test_chemo_slope=0.0016, num_experiment_repeats=10, timesteps_between_generation_of_intermediate_visuals=None, produce_final_visuals=True, full_print=True, delete_and_rerun_experiments_without_stored_env=True, run_experiments=True, remake_graphs=False, remake_animation=False, default_coa=coa_dict[4], default_cil=default_cil, chemotaxis_target_radius=160.0, box_width=2, box_height=2, box_y_placement_factor=0.5, num_cells=4)
