...
#    
    ...
    ets.no_corridor_chemoattraction_test(date_str, experiment_number, sub_experiment_number, copy.deepcopy(parameter_dict), {'source_type': 'normal', 'x_offset_in_corridor': 625.0 + 40.0, 'gaussian_width': 625.0, 'gaussian_height': 100.0}, no_randomization=False, base_output_dir="B:\\numba-ncc\\output\\", total_time_in_hours=10., timestep_length=2, verbose=True, integration_params=integration_params, max_timepoints_on_ram=max_timepoints_on_ram, seed=seed, allowed_drift_before_geometry_recalc=allowed_drift_before_geometry_recalc, default_coa=coa_dict[2], default_cil=default_cil, num_experiment_repeats=1, timesteps_between_generation_of_intermediate_visuals=None, produce_final_visuals=True, full_print=True, delete_and_rerun_experiments_without_stored_env=True, box_width=2, box_height=1, num_cells=2, box_y_placement_factor=0.5, remake_graphs=True, remake_animation=False, do_final_analysis=True, show_coa_overlay=False, coa_overlay_resolution=2)
