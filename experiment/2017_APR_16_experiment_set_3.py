...
parameter_dict.update([('kgtp_rac_multiplier', 39.0),
  ('kgtp_rho_multiplier', 34.0),
  ('kdgtp_rac_multiplier', 16.0),
  ('kdgtp_rho_multiplier', 33.0),
  ('threshold_rac_activity_multiplier', 0.55000000000000004),
  ('threshold_rho_activity_multiplier', 0.3000000000000001),
  ('kgtp_rac_autoact_multiplier', 131.0),
  ('kgtp_rho_autoact_multiplier', 166.0),
  ('kdgtp_rac_mediated_rho_inhib_multiplier', 100.0),
  ('kdgtp_rho_mediated_rac_inhib_multiplier', 1800.0),
  ('tension_mediated_rac_inhibition_half_strain', 0.069999999999999993),
  ('stiffness_edge', 7500.0), ('randomization_magnitude', 7.5), ('randomization_time_mean', 40.0), ('randomization_time_variance_factor', 0.1), ('randomization_node_percentage', 0.25)])
...
parameter_dict.update([('kgtp_rac_multiplier', 39.0),
  ...
  ('kdgtp_rho_mediated_rac_inhib_multiplier', 1800.0),
  ('tension_mediated_rac_inhibition_half_strain', 0.069999999999999993),
  ('stiffness_edge', 7500.0), ('randomization_magnitude', 3.25), ('randomization_time_mean', 40.0), ('randomization_time_variance_factor', 0.1), ('randomization_node_percentage', 0.25)])
