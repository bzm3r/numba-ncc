...
box_y_offsets = [y_offset, y_offset - (box_heights[1] - box_heights[0])*0.5*CELL_DIAMETER]
...
space_migratory_bdry_polygon, space_physical_bdry_polygon = make_space_polygons(make_migr_poly, make_phys_poly, WIDTH_MIGR_CORRIDOR, HEIGHT_MIGR_CORRIDOR, x_offset - (WIDTH_MIGR_CORRIDOR - np.sum(box_widths) - np.sum(x_space_between_boxes))*0.5, y_offset)
