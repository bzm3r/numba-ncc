...
biased_rgtpase_distrib_defn_dicts += [[{'default': ['unbiased random', np.array([-np.pi/4, np.pi/4]) + np.pi + np.pi/32, 0.1]}, {'default': ['unbiased random', np.array([-np.pi/4, np.pi/4]) + np.pi/8, 0.1]}]]
