...
ets.convergence_test_corridor(
    date_str,
    experiment_number,
    sub_experiment_number,
    parameter_dict,
    experiment_set_label="AR=1",
    ...
    default_interaction_factor_migr_bdry_contact=default_interaction_factor_migr_bdry_contact,
    ...
    biased_rgtpase_distrib_defn_dict={
        "default": ["convergence test", np.array([0, 2 * np.pi]), 0.3]
    },
)
