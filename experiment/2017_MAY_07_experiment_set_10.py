...
parameter_dict.update([('kgtp_rac_multiplier', 12.0),
  ...
  ('kgtp_rac_autoact_multiplier', 250.0),
  ('kgtp_rho_autoact_multiplier', 3*65.0),
  ('kdgtp_rac_mediated_rho_inhib_multiplier', 300.0),
  ('kdgtp_rho_mediated_rac_inhib_multiplier', 1700.0), ('tension_mediated_rac_inhibition_half_strain', 0.1),
  ('tension_mediated_rac_inhibition_magnitude', 65.0),
  ('max_force_rac', 3000.0),
  ('eta', 2.5*10000.0),
