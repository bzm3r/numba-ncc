...
if __name__ == "__main__":
  ...
  ('eta', 2.9*10000.0),
  ('stiffness_edge', 8000.0), ('randomization_time_mean', 20.0), ('randomization_time_variance_factor', 0.1), ('randomization_magnitude', 16.0), ('randomization_node_percentage', 0.25)])
