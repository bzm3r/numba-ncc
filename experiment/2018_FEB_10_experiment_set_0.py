...
if __name__ == "__main__":
    ets.corridor_migration_test(date_str, experiment_number, sub_experiment_number, copy.deepcopy(parameter_dict), no_randomization=False, base_output_dir="B:\\numba-ncc\\output\\", total_time_in_hours=1., timestep_length=2, verbose=True, integration_params=integration_params, max_timepoints_on_ram=max_timepoints_on_ram, seed=None, allowed_drift_before_geometry_recalc=allowed_drift_before_geometry_recalc, default_coa=coa_dict[49], default_cil=60.0, num_experiment_repeats=1, timesteps_between_generation_of_intermediate_visuals=None, produce_final_visuals=True, full_print=True, delete_and_rerun_experiments_without_stored_env=True, box_width=7, box_height=7, num_cells=49, corridor_height=7, box_y_placement_factor=0.5, remake_graphs=False, remake_animation=True, do_final_analysis=False, colorscheme="scifi", show_coa_overlay=True, coa_overlay_resolution=2, corridor_definition=["regular curve", 7*40, 1000, 100, -1], specific_timesteps_to_draw_as_svg=[17999])

#    ets.corridor_migration_test(date_str, experiment_number, sub_experiment_number, copy.deepcopy(parameter_dict), no_randomization=False, base_output_dir="B:\\numba-ncc\\output\\", total_time_in_hours=10., timestep_length=2, verbose=True, integration_params=integration_params, max_timepoints_on_ram=max_timepoints_on_ram, seed=None, allowed_drift_before_geometry_recalc=allowed_drift_before_geometry_recalc, default_coa=coa_dict[49], default_cil=60.0, num_experiment_repeats=1, timesteps_between_generation_of_intermediate_visuals=None, produce_final_visuals=True, full_print=True, delete_and_rerun_experiments_without_stored_env=True, box_width=7, box_height=7, num_cells=49, corridor_height=7, box_y_placement_factor=0.5, remake_graphs=False, remake_animation=True, do_final_analysis=do_final_analysis, colorscheme="scifi", show_coa_overlay=True, coa_overlay_resolution=1000, corridor_definition=["regular curve", 7*40, 1000, 100, -1])
