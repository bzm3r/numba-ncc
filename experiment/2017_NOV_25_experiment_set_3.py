...
ets.corridor_migration_coa_tests(date_str, experiment_number, sub_experiment_number, copy.deepcopy(parameter_dict), experiment_set_label="", no_randomization=False, base_output_dir="B:\\numba-ncc\\output\\", total_time_in_hours=10, timestep_length=2, verbose=True, closeness_dist_squared_criteria=closeness_dist_squared_criteria, integration_params=integration_params, max_timepoints_on_ram=max_timepoints_on_ram, seed=None, allowed_drift_before_geometry_recalc=allowed_drift_before_geometry_recalc, test_coas=[8.0*x for x in np.arange(13)] + [8.0*15], default_cil=default_cil, num_cells=4, box_height=1, box_width=4, corridor_height=1, num_experiment_repeats=20, particular_repeats=[], timesteps_between_generation_of_intermediate_visuals=None, produce_final_visuals=True, full_print=True, delete_and_rerun_experiments_without_stored_env=True, run_experiments=False, remake_graphs=False, remake_animation=False, do_final_analysis=False, justify_parameters=False)

#ets.corridor_migration_cil_tests(date_str, experiment_number, sub_experiment_number, copy.deepcopy(parameter_dict), experiment_set_label="", no_randomization=False, base_output_dir="B:\\numba-ncc\\output\\", total_time_in_hours=10, timestep_length=2, verbose=True, closeness_dist_squared_criteria=closeness_dist_squared_criteria, integration_params=integration_params, max_timepoints_on_ram=max_timepoints_on_ram, seed=None, allowed_drift_before_geometry_recalc=allowed_drift_before_geometry_recalc, test_cils=[30.0*x for x in np.arange(0, 8)], default_coa=24.0, num_cells=4, box_height=1, box_width=4, corridor_height=1, num_experiment_repeats=20, particular_repeats=[], timesteps_between_generation_of_intermediate_visuals=None, produce_final_visuals=True, full_print=True, delete_and_rerun_experiments_without_stored_env=True, run_experiments=False, remake_graphs=False, remake_animation=False, do_final_analysis=False, justify_parameters=False)
