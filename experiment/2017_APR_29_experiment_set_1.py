...
parameter_dict.update([('kgtp_rac_multiplier', 1.8*10.0),
  ...
  ('kdgtp_rac_mediated_rho_inhib_multiplier', 200.0),
  ('kdgtp_rho_mediated_rac_inhib_multiplier', 2000.0),
  ('tension_mediated_rac_inhibition_half_strain', 0.05), ('tension_mediated_rac_inhibition_magnitude', 6.25), ('max_force_rac', 0.1*10e3), ('eta', 0.1*1e5), ('randomization_time_mean', 40.0), ('randomization_time_variance_factor', 0.1), ('randomization_magnitude', 4.0), ('randomization_node_percentage', 0.25), ('stiffness_edge', 2500.)])
