...
parameter_dict.update([('kgtp_rac_multiplier', 17.0),
  ...
  ('tension_mediated_rac_inhibition_half_strain', 0.095),
  ('stiffness_edge', 5500.0), ('randomization_magnitude', 10.0), ('randomization_time_mean', 40.0), ('randomization_time_variance_factor', 0.1), ('randomization_node_percentage', 0.45)])
