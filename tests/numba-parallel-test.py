...
cells_bounding_box_array = geometry.create_initial_bounding_box_polygon_array(
    num_cells, num_nodes_per_cell, all_cells_node_coords
)
et = time.time()
...
distance_squared_matrix, line_segment_intersection_matrix = geometry.create_initial_line_segment_intersection_and_dist_squared_matrices_old(
    num_cells, num_nodes_per_cell, cells_bounding_box_array, all_cells_node_coords
)
et = time.time()

print(
    "create_initial_line_segment_intersection_and_dist_squared_matrices: {}s".format(
        format_time(et - st)
    )
)
...
for ci in range(num_cells):
    ...
    distance_squared_matrix, line_segment_intersection_matrix = geometry.update_line_segment_intersection_and_dist_squared_matrices_old(
        ci,
        num_cells,
        num_nodes_per_cell,
...
print(
    "update_line_segment_intersection_and_dist_squared_matrices: {}s".format(
        format_time(et - st)
    )
)
