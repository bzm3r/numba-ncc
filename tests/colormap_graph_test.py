...
def graph_coa_variation_test_data(
    ...
    cbar = fig.colorbar(
        cax,
        boundaries=np.linspace(1.0, max_normalized_group_area, num=100),
        ticks=np.linspace(1.0, max_normalized_group_area, num=5),
    )
    ...
    if save_dir == None:
        ...
        save_path = os.path.join(
            save_dir, "coa_variation_results_{}".format(sub_experiment_number) + ".png"
        )
